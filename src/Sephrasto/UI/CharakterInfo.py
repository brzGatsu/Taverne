...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 527, 821))
        ...
        self.gridLayout_2.addWidget(self.spinUeberTalentePercent, 7, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.spinUeberTalenteSpent, 7, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.labelUeber2, 6, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.spinUebernatuerlichPercent, 5, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.labelUeber3, 7, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.labelUeber1, 5, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.spinUeberFertigkeitenPercent, 6, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.spinUeberFertigkeitenSpent, 6, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.spinUebernatuerlichSpent, 5, 1, 1, 1)
...
#if QT_CONFIG(tooltip)
        self.checkUeberPDF.setToolTip(QCoreApplication.translate("Form", u"<html><head/><body><p>Taverne \u00fcbernimmt automatisch alle \u00fcbernat\u00fcrlichen Fertigkeiten in den Charakterbogen, deren FW mindestens 1 betr\u00e4gt und f\u00fcr welche du mindestens ein Talent aktiviert hast. Wenn du diese Option aktivierst, zeigt Taverne eine PDF-Spalte bei den \u00fcbernat\u00fcrlichen Fertigkeiten an. Mit dieser kannst du selbst entscheiden, welche Fertigkeiten in den Charakterbogen \u00fcbernommen werden sollen.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.checkRegeln.setToolTip(QCoreApplication.translate("Form", u"<html><head/><body><p>Taverne kann automatisch alle Regeln, die f\u00fcr deinen Charakter relevant sind, zusammentragen und deiner PDF hinten anf\u00fcgen.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.comboCharsheet.setToolTip(QCoreApplication.translate("Form", u"<html><head/><body><p>Hier erscheinen alle Charakterb\u00f6gen, die mit Taverne geliefert werden sowie alle aus deinem Charakterbogen-Pfad.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
