...
class Ui_SettingsWindow(object):
    def setupUi(self, SettingsWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 766, 728))
    ...
    def retranslateUi(self, SettingsWindow):
        SettingsWindow.setWindowTitle(QCoreApplication.translate("SettingsWindow", u"Taverne - Einstellungen", None))
        ...
        self.label_16.setText(QCoreApplication.translate("SettingsWindow", u"Dem Charakterbogen Drachent\u00f6ter Regeln anh\u00e4ngen", None))
...
#if QT_CONFIG(tooltip)
        self.comboBogen.setToolTip(QCoreApplication.translate("SettingsWindow", u"<html><head/><body><p>Hier erscheinen alle Charakterb\u00f6gen, die mit Taverne geliefert werden sowie alle aus deinem Charakterbogen-Pfad, siehe unten. Der gew\u00e4hlte Charakterbogen wird bei neuen Charakteren automatisch aktiv gesetzt. Dies kannst du nachtr\u00e4glich im Info-Tab des Charaktereditors \u00e4ndern.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.checkCheatsheet.setToolTip(QCoreApplication.translate("SettingsWindow", u"<html><head/><body><p>Taverne kann automatisch alle Regeln, die f\u00fcr deinen Charakter relevant sind, zusammentragen und deiner PDF hinten anf\u00fcgen. Diese Einstellung gilt f\u00fcr neue Charaktere. Du kannst sie nachtr\u00e4glich im Info-Tab des Charaktereditors \u00e4ndern.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.checkUpdate.setToolTip(QCoreApplication.translate("SettingsWindow", u"<html><head/><body><p>Falls aktiviert sendet Taverne bei jedem Start eine Anfrage an github.com, um nachzusehen, ob es eine neuere Version gibt.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.checkDPI.setToolTip(QCoreApplication.translate("SettingsWindow", u"<html><head/><body><p>Viele Betriebssysteme bieten an, Programme, Schriften usw. gr\u00f6\u00dfer darzustellen. Taverne kann diese sogenannte DPI-Skalierung vom Betriebssystem \u00fcbernehmen. Dabei kann es aktuell allerdings noch zu Darstellungsfehlern wie niedrigaufgel\u00f6sten Bildern oder Icons kommen.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
