...
class Ui_formBeschreibung(object):
    def setupUi(self, formBeschreibung):
        ...
        self.gridLayout.addWidget(self.labelKurzbeschreibung, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.labelHeimat, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.comboHeimat, 3, 2, 1, 1)
